...
"""
    AlternativeForwardPass(
        forward_model::RDDIP.PolicyGraph{T};
...
[`RDDIP.AlternativePostIterationCallback`](@ref) to the `post_iteration_callback`
argument of [`RDDIP.train`](@ref).
...
[`RDDIP.AlternativeForwardPass`](@ref) is used.
"""
