...
"""
	RDDIP.SpaghettiPlot(; stages, scenarios)
...
"""
	RDDIP.add_spaghetti(data_function::Function, plt::SpaghettiPlot; kwargs...)
...
plt = RDDIP.spaghetti_plot(simulations)
RDDIP.add_spaghetti(plt; title = "Stage objective") do data
...
function save(p::SpaghettiPlot, args...; kwargs...)
    Base.depwarn("`RDDIP.save` is deprecated. Use `RDDIP.plot` instead.", :save)
