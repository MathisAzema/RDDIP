...
A representation of the value function. RDDIP.jl uses the following unique representation of
...
`@variable(sp, volume[1:4] >= 0, RDDIP.State, initial_value = 0.0)`, use `[i]` to
