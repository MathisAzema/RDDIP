...
# Internal function: convert dataset (from RDDIP.simulate) into a matrix where
...
## Examples
    ...
    RDDIP.publication_plot(simulations; title = "My title") do data
...
function publication_plot(
    ...
    return RDDIP.publicationplot(simulations, data_function; kwargs...)
end
