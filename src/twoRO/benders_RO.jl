...
function benders_RO_bin_callback(instance, options;silent=true, Γ=0, force=1, gap=0.05, timelimit=10)
    ...
    function my_callback_function(cb_data, cb_where::Cint)
        ...
        if cb_where==GRB_CB_MIPSOL
            ...
            update_UB, second_stage_cost_ub, worst_case_cost = add_cut_RO_bin(cb_data, twoROmodel, instance, Time_subproblem, states_1_val, solution_gamma, Γ; gap=gap)
