...
You need to define the following methods:
 - [`RDDIP.stopping_rule_status`](@ref)
 - [`RDDIP.convergence_test`](@ref)
"""
...
You need to define the following methods:
 - [`RDDIP.sample_backward_noise_terms`](@ref)
"""
...
The solve loop of the RDDIP algorithm. Returns a symbol corresponding to the
termination status.
"""
